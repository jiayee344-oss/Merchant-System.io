// ================= 并发加载 + 呼叫按钮（新表格） =================
const SPREADSHEET_ID = '1j2ztP9HzfcbxIG8KKgaYhNVSb7oOabFzLpyGMtmMV4w';
// ⚠️ 重要：请确认访谈时间工作表的 gid，示例使用旧值，您需要改成新表格中对应的 gid
const INTERVIEW_SHEET_GID = '1770762674';  // 请修改为实际访谈工作表的 gid
...
async function getAllSheets() {
    return [
        { name: '1. 美业（31) WH JM', gid: '0' },
        { name: '2. 餐厅 （31）WH WW', gid: '1919651570' },
        { name: '餐饮（JJ）', gid: '1166122120' },
        { name: '3. 衣服（31) Leon', gid: '2101066600' },
        { name: '4. Interior Design（31) WW', gid: '777591929' },
        { name: '5. 家具店（31) ZX', gid: '1592112329' },
        { name: '6. 眼镜（31) Donny', gid: '70200528' },
        { name: '7. gym&pilates（31) LEON', gid: '1088951287' },
        { name: '9. 宠物店（31) JM', gid: '1184046734' },
        { name: '9. 婚纱摄影（31) Leon', gid: '616949018' },
        { name: '10. 旅游（31) ZX', gid: '1908845895' },
        { name: '12. 烘培店（31) DONNY', gid: '1548218210' },
        { name: '13. 餐饮 Clovin', gid: '416772624' },
        { name: '14.JM cafe', gid: '1640211163' },
        { name: '餐厅  TW', gid: '1320716975' },
        { name: 'kailun', gid: '547116251' }
    ];
}
        ...
        if (cleanNumber) {
            phoneHtml = `
                ...
                <div class="phone-buttons">
                    <button class="call-btn" data-number="${cleanNumber}">📞 ${callText}</button>
                    <button class="copy-btn" data-number="${cleanNumber}">📋 ${copyText}</button>
                </div>
            `;
        } else {
